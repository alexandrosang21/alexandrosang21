...
Full-stack developer based in Greece. I build web apps with TypeScript, Next.js, React Native and Astro, and browser games on the side.

Portfolio: [cv.angelov.gr](https://cv.angelov.gr)
...
I also work on private projects: an ASO keyword intelligence tool, an expense-splitting mobile app (Expo + Next.js monorepo), and an AI chatbot builder for Greek businesses.
